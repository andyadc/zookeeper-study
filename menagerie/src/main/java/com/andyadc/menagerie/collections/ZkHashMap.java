 ...
 */
package com.andyadc.menagerie.collections;

import com.andyadc.menagerie.ClusterSafe;
import com.andyadc.menagerie.Serializer;
import com.andyadc.menagerie.ZkSessionManager;
import com.andyadc.menagerie.ZkUtils;
import com.andyadc.menagerie.locks.ReentrantZkLock;
import com.andyadc.menagerie.locks.ReentrantZkReadWriteLock;
 ...
 * {@link #ZkHashMap(String, com.andyadc.menagerie.ZkSessionManager, List, com.andyadc.menagerie.Serializer, int)} constructor.
...
public final class ZkHashMap<K, V> implements ConcurrentMap<K, V> {
     ...
     * the {@link ZooDefs.Ids.OPEN_ACL_UNSAFE} privileges in ZooKeeper.
     *
...
/*-------------------------------------------------------------------------------------------------------------------*/
        ...
        V get(Object key, int hash) {
            ...
            try {
                ...
                for (String match : hashMatches) {
                    ...
                    if (data.length > 0) {
                        Entry<K, V> deserializedEntry = serializer.deserialize(data);
    ...
    private class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        public int size() {
            return ZkHashMap.this.size();
        }

        public void clear() {
            ZkHashMap.this.clear();
        }
    }
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        @Override
        public boolean contains(Object o) {
            return ZkHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return ZkHashMap.this.remove(o) != null;
        }
    }
    ...
    private class ValuesCollection extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return ZkHashMap.this.containsValue(o);
        }
