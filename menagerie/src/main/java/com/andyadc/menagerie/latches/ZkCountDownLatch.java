...
public class ZkCountDownLatch extends AbstractZkBarrier {
     ...
     * to remain alive. use {@link #ZkCountDownLatch(long, String, com.andyadc.menagerie.ZkSessionManager, List, boolean)}
     * instead
     *
     ...
     * @throws InterruptedException if the current thread is interrupted, or if communication between the ZooKeeper
     *                              client and server fails in some way
     * @throws RuntimeException     wrapping a {@link KeeperException} if the ZooKeeper server goes
     *                              wrong.
     */
